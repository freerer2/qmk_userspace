...
LT(U_MOUSE,KC_Z),	KC_X,				KC_C,				KC_V,				KC_B,				KC_N,				KC_M,				KC_COMM,			KC_DOT,				TD(U_TD_SLSH_SCRL),	\
										LT(U_DEBUG,KC_ESC),	LT(U_NAV,KC_SPC),	LT(U_DIGI,KC_TAB),	LT(U_FUN,KC_ENT),	LT(U_NUM,KC_BSPC),	KC_DEL
...
#define LAYER_FUN \
KC_NO,				KC_F7,				KC_F8,				KC_F9,				KC_PSCR,			KC_NO,				KC_NO,				KC_NO,				KC_NO,				TD(U_TD_BOOT),		\
KC_NO,				KC_F4,				KC_F5,				KC_F6,				KC_SCRL,			KC_NO,				KC_LSFT,			KC_LCTL,			KC_LALT,			KC_LGUI,			\
KC_NO,				KC_F1,				KC_F2,				KC_F3,				KC_PAUS,			KC_NO,				KC_NO,				KC_NO,				KC_ALGR,			KC_RCTL,			\
...
#define LAYER_DIGI \
B_A_A,				B_B_A,				B_C_A,				B_D_A,				B_E_A,				B_F_A,				B_G_A,				B_H_A,				B_I_A,				B_J_A,				\
B_A_B,			    B_B_B,				B_C_B,				B_D_B,				B_E_B,				B_F_B,				B_G_B,				B_H_B,				B_I_B,				B_J_B,				\
B_A_C,				B_B_C,				B_C_C,				B_D_C,				B_E_C,				B_F_C,				B_G_C,				B_H_C,				B_I_C,				B_J_C,				\
										KC_NO,				KC_NO,				KC_NO,				KC_NO,				KC_NO,				KC_NO
