...
KC_NO,				ECLIPSE,			BROWSER,			NEXACRO,			KC_NO,				KC_NO,				KC_NO,				KC_NO,				KC_NO,				KC_NO,				\
	...
	#define LAYER_MOUSE \
	U_UND,				C(KC_W),			KC_NO,				C(S(KC_R)),			U_RDO,				DPI_MOD,			U_WINFLT,			U_WINUP,			U_WINFRT,			S_D_MOD,			\
	KC_LGUI,			KC_LALT,			KC_LCTL,			KC_LSFT,			C(KC_H),			KC_NO,				KC_LSFT,			KC_LCTL,			KC_LALT,			KC_LGUI,			\
...
#else
	#define LAYER_MOUSE \
	U_UND,				C(KC_W),			KC_NO,				C(S(KC_R)),			U_RDO,				KC_NO,				U_WINFLT,			MS_UP,				U_WINFRT,			KC_NO,				\
	KC_LGUI,			KC_LALT,			KC_LCTL,			KC_LSFT,			C(KC_H),			KC_NO,				MS_LEFT,			MS_DOWN,			MS_RGHT,			KC_NO,				\
